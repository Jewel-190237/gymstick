...
const Shop: React.FC = () => {
    ...
    return (
        <section className='max-w-[1320px] mx-auto my-10'>
            ...
            <div className="">
                <div className="flex justify-center mb-4 border w-[100%] md:w-[66.5%] lg:w-[51.3%] mx-auto rounded">
                    {tabs.map(tab => (
                        <button
                            key={tab}
                            className={`px-2 md:px-4 rounded py-2 md:py-4 ${activeTab === tab ? 'bg-[#E67529] text-white' : 'text-black bg-white'}`}
